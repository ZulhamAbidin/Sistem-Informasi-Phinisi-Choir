                                        ...
                                        <div class="card border p-0 shadow-none">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <p class="mb-0">{{ strlen(strip_tags($postingan->deskripsi)) > 50 ? substr(strip_tags($postingan->deskripsi), 0, 100) . 'Lihat Selengkapnya..' :
                                                    strip_tags($postingan->deskripsi) }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-footer user-pro-2">
                                                <div class="media mt-0">
                                                    <div class="media-body">
                                                        <h6 class="mb-0 mt-2 ms-2">{{ $postingan->jumlah_suka }} Orang Menyukai
                                                            Postingan Ini</h6>
                                                    </div>
                                                    <div class="ms-auto">
