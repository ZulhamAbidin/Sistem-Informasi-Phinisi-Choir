...
<div class="row justify-content-center mt-4">
    ...
    <div class="col-md-12 ">
        ...
        <div class="modal fade effect-scale show" id="confirmDeleteModal{{ $anggotas->id }}" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-dialog-centered text-center" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="card-text">Apakah kamu yakin ingin menghapus data anggota {{ $anggotas->nama_lengkap }} ini?</p>
                    </div>
                    <div class="modal-footer">
                        <a href="javascript:void(0)" class="btn btn-white" onclick="hideCustomAlert({{ $anggotas->id }})">Cancel</a>
                ...
                <div class="product-grid6">
                    <div class="product-image6 p-5">
                        <ul class="icons">
                            ...
                            <li><button class="btn btn-danger" onclick="showCustomAlert({{ $anggotas->id }})"><i class="fe fe-x"></i></button> </li>
                        </ul>
