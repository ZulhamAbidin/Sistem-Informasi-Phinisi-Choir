    ...
    <div class="rounded-l-lg  pt-4 pb-1 dark:bg-navy-800">
        ...
        {{-- <div class="flex">
            <div class="swiper mx-0 mt-4 px-[var(--margin-x)] transition-all duration-[.25s] swiper-initialized swiper-horizontal swiper-backface-hidden"
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-a7dcd7396d43dd82" aria-live="polite"
                    ...
                    <div class="card swiper-slide flex w-96 shrink-0 justify-between rounded-xl border-l-4 border-primary p-4 swiper-slide-active"
                        ...
                        <div>
                            <div class="card grow items-center p-4 sm:p-5">
                                <div class="avatar h-28 w-28">
                                    <img class="rounded-full" src="{{ asset('storage/uploads/' . $testimonial->foto) }}"
                                        alt="avatar">
                                    <div
                                        class="absolute right-0 m-1 h-4 w-4 rounded-full border-2 border-white bg-primary dark:border-navy-700 dark:bg-accent">
                                    </div>
                                ...
                                <p class="text-xs+ text-center text-slate-900 font-semibold">{{ $testimonial->jabatan }}</p>
                                <div class="my-4 h-px w-full bg-slate-200 dark:bg-navy-500"></div>
                                <p class="text-xs+ text-center text-slate-900 font-semibold">{{ $testimonial->content }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
        ...
        {{-- <div class="scrollbar-sm mt-4 h-fit flex space-x-4 overflow-x-auto px-4 pb-4 sm:px-5" style="height: fit-content !important; ">
                ...
                <div class="card mx-2 h-fit -mt-8 grow rounded-2xl p-3.5" style="height: fit-content !important; ">
                    <div class="mt-2">
                        <div
                            class="text-sm font-medium text-center text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            {{ $testimonial->content }}
                        </div>
                    </div>
