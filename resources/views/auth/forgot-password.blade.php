            ...
            <div class="w-full max-w-[26rem] p-4 sm:px-5">
                <div class="text-center">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-slate-400 dark:text-navy-300">
                            Silahkan masukkan alamat email untuk melanjutkan
                        </p>
                    </div>
                </div>

                @if(session('status'))
                    <div class="alert mt-4 flex overflow-hidden rounded-lg border border-primary text-primary">
                        ...
                        <div class="px-4 py-3 text-xs+ sm:px-5"> Silahkan Cek Alamat Email Anda Untuk Melakukan Pemulihan</div>
                    </div>
                @endif
                ...
                <div class="card mt-5 rounded-lg p-5 lg:p-7">
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        @error('email')
                        <span class="invalid-feedback strong text-xs text-error" role="alert">
                            {{ $message }}
                        </span>
                        @enderror
                        <button type="submit"
