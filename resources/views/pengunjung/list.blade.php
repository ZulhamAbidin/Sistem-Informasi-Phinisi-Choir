                            ...
                            <div class="card-body">
                                <form action="{{ route('ListBerita') }}" method="GET">
                                    <div class="input-group mb-2">
                                        <input type="text" name="search" value="{{ $search }}" class="form-control" id="search" placeholder="Searching.....">
                                        <button type="submit" class="input-group-text btn btn-sm btn-primary">Search</button>
                                        <a href="{{ route('ListBerita') }}" class="input-group-text btn btn-sm btn-primary" id="showAll">X</a>
                                    </div>
                                </form>
                            </div>
                        </div>
