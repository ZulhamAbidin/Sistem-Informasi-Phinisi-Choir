                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="input-group mb-2">
                                    ...
                                    <span class="input-group-text btn btn-sm btn-primary">Search</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    @if (!is_null($listberita) && count($listberita) > 0)
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="media mt-0">
                                                                ...
                                                                <div class="media-body">
                                                                    <h6 class="mb-0 mt-1">
                                                                        {{ $postingan->author }}
                                                                        <!-- Ganti author dengan atribut penulis -->
                                                                    </h6>
                                                                    <small class="text-muted">
                                                                        {{ $postingan->created_at->diffForHumans() }}
                                                                        <!-- Ubah ke atribut yang menyimpan waktu posting -->
                                                                    </small>
                                                                </div>
                                                            </div>
                                                            <div class="ms-auto">
                                        ...
                                        @endforeach
                                    @else
                                        <p>Admin Belum Mengunggah Postingan Apapun.</p>
                                    @endif
                                </div>
                            </div>
                        </div>
