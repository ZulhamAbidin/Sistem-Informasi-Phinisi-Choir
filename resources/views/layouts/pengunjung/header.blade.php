            ...
            <div class="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden sm:flex-col">
                ...
                <div class="flex w-full items-center justify-between sm:h-16">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                        ...
                        <div
                            ...
                            <div class="{{ request()->is('/') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            ...
                            <div class="{{ request()->is('pengunjung/competition') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                                <a href="{{ route('ListCompetition') }}"
                                    class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                    :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                            ...
                            <div class="{{ request()->is('pengunjung/achievement') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            ...
                            <div  class="{{ request()->is('about') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                                <a href="{{ route('about') }}"
                                    class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                    :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                                    <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    class="is-scrollbar-hidden sm:flex hidden lg:hidden justify-center -mx-2  h-12 items-center space-x-2 overflow-y-auto font-inter ">
                        ...
                        <div
                            class="{{ request()->is('/') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            <a href="{{ route('welcome') }}" class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                                <svg class="h-6 w-6" xmlns="../www.w3.org/2000/svg.html" fill="none" viewBox="0 0 24 24">
                                    <path fill="currentColor" fill-opacity=".3"
                                        d="M5 14.059c0-1.01 0-1.514.222-1.945.221-.43.632-.724 1.453-1.31l4.163-2.974c.56-.4.842-.601 1.162-.601.32 0 .601.2 1.162.601l4.163 2.974c.821.586 1.232.88 1.453 1.31.222.43.222.935.222 1.945V19c0 .943 0 1.414-.293 1.707C18.414 21 17.943 21 17 21H7c-.943 0-1.414 0-1.707-.293C5 20.414 5 19.943 5 19v-4.94Z" />
                        ...
                        <div
                            class="{{ request()->is('pengunjung/competition') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            <a href="{{ route('ListCompetition') }}" class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                                <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-opacity="0.25"
                                        d="M21.0001 16.05V18.75C21.0001 20.1 20.1001 21 18.7501 21H6.6001C6.9691 21 7.3471 20.946 7.6981 20.829C7.7971 20.793 7.89609 20.757 7.99509 20.712C8.31009 20.586 8.61611 20.406 8.88611 20.172C8.96711 20.109 9.05711 20.028 9.13811 19.947L9.17409 19.911L15.2941 13.8H18.7501C20.1001 13.8 21.0001 14.7 21.0001 16.05Z"
                        ...
                        <div
                            class="{{ request()->is('pengunjung/achievement') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            <a href="{{ route('ListAchievement') }}" class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                                <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-opacity="0.5"
                        ...
                        <div
                            class="{{ request()->is('about') ? 'font-medium text-primary dark:text-accent-light shadow-lg rounded-xl' : '' }} inline-flex ">
                            <a href="{{ route('about') }}" class="btn space-x-2 px-2 py-1.5 text-xs+ font-medium leading-none"
                                :class="isShowPopper ? 'bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100' : 'text-slate-600 hover:text-slate-800 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25'">
                                <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-opacity="0.25"
                                        d="M21.0001 16.05V18.75C21.0001 20.1 20.1001 21 18.7501 21H6.6001C6.9691 21 7.3471 20.946 7.6981 20.829C7.7971 20.793 7.89609 20.757 7.99509 20.712C8.31009 20.586 8.61611 20.406 8.88611 20.172C8.96711 20.109 9.05711 20.028 9.13811 19.947L9.17409 19.911L15.2941 13.8H18.7501C20.1001 13.8 21.0001 14.7 21.0001 16.05Z"
