    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a href="{{ route('admin.dashboard') }}" class="side-menu__item has-link active" data-bs-toggle="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="javascript:void(0)"><span
                                    class="sub-side-menu__label">Jumbotron</span><i class="sub-angle fe fe-chevron-right"></i></a>
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="{{ route('jumbotron.index') }}">List Jumbotron</a></li>
                                <li><a class="sub-slide-item" href="{{ route('jumbotron.create') }}">Create Jumbotron</a></li>
                            </ul>
                        </li>
